...
import cinebook.bookingservice.dto.response.ApiErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDTO> handleSeatConflict(SeatConflictException ex) {
        ApiErrorDTO error = ApiErrorDTO.builder()
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<ApiErrorDTO> handleReservationExpired(ReservationExpiredException ex) {
        ApiErrorDTO error = ApiErrorDTO.builder()
                .timestamp(LocalDateTime.now())
